...
public class fromStringToCharParserBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements fromStringToCharParserVisitor<T> {
	 ...
	 */
	@Override public T visitStart(@NotNull fromStringToCharParserParser.StartContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitExpression(@NotNull fromStringToCharParserParser.ExpressionContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitString(@NotNull fromStringToCharParserParser.StringContext ctx) { return visitChildren(ctx); }
}
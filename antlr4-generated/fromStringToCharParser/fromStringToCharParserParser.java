...
public class fromStringToCharParserParser extends Parser {
	...
	@Override
	public String getGrammarFileName() { return "fromStringToCharParser.g4"; }
	...
	public static class StartContext extends ParserRuleContext {
		...
		public TerminalNode EOF() { return getToken(fromStringToCharParserParser.EOF, 0); }
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof fromStringToCharParserVisitor ) return ((fromStringToCharParserVisitor<? extends T>)visitor).visitStart(this);
	...
	public static class ExpressionContext extends ParserRuleContext {
		...
		public List<TerminalNode> LSEPARATOR() { return getTokens(fromStringToCharParserParser.LSEPARATOR); }
		public TerminalNode LSEPARATOR(int i) {
			return getToken(fromStringToCharParserParser.LSEPARATOR, i);
		}
		public List<TerminalNode> RSEPARATOR() { return getTokens(fromStringToCharParserParser.RSEPARATOR); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof fromStringToCharParserVisitor ) return ((fromStringToCharParserVisitor<? extends T>)visitor).visitExpression(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class StringContext extends ParserRuleContext {
		public TerminalNode EVERYTHING() { return getToken(fromStringToCharParserParser.EVERYTHING, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof fromStringToCharParserVisitor ) return ((fromStringToCharParserVisitor<? extends T>)visitor).visitString(this);
			else return visitor.visitChildren(this);
		}
	}

    ...
    public void declarePerformances() {
        ...
        for(String c : constraints) {
            ...
            */
            ...
            newAutomaton = AutomatonUtils.ldlf2Automaton(ldlff, ldlff.getSignature());

            // So called "declare assumption" removes all the transitions with more than one propositional symbol
            newAutomaton = AutomatonUtils.declareAssumption(newAutomaton);

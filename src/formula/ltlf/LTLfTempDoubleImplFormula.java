 ...
 */
public class LTLfTempDoubleImplFormula<S extends Symbol<?>> extends LTLfBinaryFormula<S> implements DoubleImplFormula<S>, LTLfBoolOpTempFormula<S> {
    ...
    public boolean equals(Object o) {
        if (o != null && this.getClass().equals(o.getClass())) {
            LTLfTempDoubleImplFormula<S> other = (LTLfTempDoubleImplFormula<S>) o;

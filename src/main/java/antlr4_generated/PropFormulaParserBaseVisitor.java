...
/**
 * This class provides an empty implementation of {@link PropFormulaParserVisitor},
 ...
 */
public class PropFormulaParserBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements PropFormulaParserVisitor<T> {
	/**
	 * {@inheritDoc}
	 *
